...
const pocketExtension = (function() {
  var __request_code;
  ...
  */
  ...
  function getRedirectUrl () {
    return "https://ikndkhohinloomoacdggllledgjehkcf.chromiumapp.org/provider_cb";
  }
  ...
  function lauchChromeWebAuthFlowAndReturnAccessToken (request_code) {
    redirect_url = getRedirectUrl();
    chrome.identity.launchWebAuthFlow({'url': "https://getpocket.com/auth/authorize?request_token="+ request_code + "&redirect_uri="+ redirect_url, 'interactive': true}, function(redirect_url2) {
